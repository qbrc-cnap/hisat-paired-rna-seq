...
def check_constraints(implemented_constraint, inputs_json_path):
    ...
    The length of the HisatPairedRnaSeqAndDgeWorkflow.r1_files key will be used as the
    ...
    try:
        fastq_list = j['HisatPairedRnaSeqAndDgeWorkflow.r1_files']
    except KeyError:
        # The chances of reaching this are very unlikely, but we are being extra careful here
        print('This should not happen-- the HisatPairedRnaSeqAndDgeWorkflow.r1_files key should be present in your inputs JSON file')
        return False
